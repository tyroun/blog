...
无人驾驶、无人安防、人脸识别、车辆车牌识别、以图搜图、VR/AR、3D 重构、无人机、医学图像分析、其他
...
根据评分卡模型应用的业务阶段不用，评分卡模型主要分为三大类：A 卡（Application score card）申请评分卡、B 卡（Behavior score card）行为评分卡、C 卡（Collection score
